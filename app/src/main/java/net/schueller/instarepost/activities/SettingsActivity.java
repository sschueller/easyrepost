...
/**
 * A {@link PreferenceActivity} that presents a set of application mainmenu. On
 * handset devices, mainmenu are presented as a single list. On tablets,
 * mainmenu are split by category, with category headers shown to the left of
 * the list of mainmenu.
 * <p>
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("pref_instagram_username"));
            //bindPreferenceSummaryToValue(findPreference("example_list"));

            // clear all
            Preference clearAll = findPreference("pref_clear_all");
            clearAll.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {

                    AlertDialog.Builder builder = new AlertDialog.Builder(preference.getContext());
                    builder.setMessage(R.string.dialog_are_you_sure_you_want_to_delete_all).setPositiveButton(R.string.dialog_yes, dialogClickListener)
